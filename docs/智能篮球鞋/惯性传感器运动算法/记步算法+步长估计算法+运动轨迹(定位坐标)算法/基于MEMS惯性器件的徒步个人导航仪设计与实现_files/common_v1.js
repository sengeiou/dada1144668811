...
(function(window){
	...
	link_kyzq = new RegExp('docin.com/kyzq/index.do');//考研专区
	...
	var connectOnline = '<div class="connectOnline"><a class="t" href="javascript:window.open('
				+ '\''
				+ 'http://b.qq.com/webc.htm?new=0&sid=800004241&eid=2188z8p8p8p8p8Q8K8Q8q&o=http://www.docin.com&q=7&ref='
				+ document.location
				+ '\', \''
				+ '_blank'
				+ '\', \'height=544, width=644,toolbar=no,scrollbars=no,menubar=no,status=no\''
				+ ');" title="在线客服">在线客服</a></div>';
	/*微信推广*/
	if (typeof build_conf != 'undefined') {
		var docin_wx = '<a href="javascript:void(0);" class="t">微信推广</a><div class="downloadMore"><p>添加微信关注，惊喜好礼不定期派送中</p><dl class="clear"><dt><img class="DocinWxImg_jz" src="" alt="豆丁建筑"></dt><dd>豆丁建筑</dd><dd class="txt5">微信号：doudingjz</dd><dd class="bsb">扫左侧二维码关注“豆丁建筑”微信公众号，</dd><dd class="bsb">最新的建筑行业动态、最热的建筑行业知识、更多的建筑经验分享，做一个快乐分享平台，一起关注豆丁建筑吧！</dd></dl><span class="line clear"></span><p></p><dl class="clear"><dt><img class="DocinWxImg_sg" src="" alt="豆丁施工"></dt><dd>豆丁施工</dd><dd class="txt5">微信号：docinsg</dd><dd class="bsb">扫左侧二维码关注“豆丁施工”微信公众号，</dd><dd class="bsb">豆丁施工伴你提高工程施工技术水平......</dd></dl></div>';
	} else {
		var docin_wx = '<a href="javascript:void(0);" class="t">微信推广</a><div class="downloadMore"><p>添加微信关注，<span>惊喜好礼不定期派送中</span></p><dl class="clear"><dt><img class="DocinWxImg" src="" alt="豆丁网"></dt><dd>豆丁网</dd><dd class="txt5">微信号：doudingwang</dd><dd>扫左侧二维码关注“豆丁网”微信公众号，</dd><dd><span>随时随地即可享受多重好礼</span></dd></dl><span class="line clear"></span><p>更多豆丁微信号</p><div class="downloadList clear"><ul class=""><li><img class="docBuildImg" src="" alt="豆丁建筑"></li><li>豆丁建筑</li><li>微信号：doudingjz</li></ul><ul class=""><li><img class="docWordImg" src="" alt="豆丁文档"></li><li style="padding-left:15px;">豆丁文档<img class="docWordDyh" src="" style="vertical-align:middle;padding-left:10px;"></li><li>微信号：docin2013</li></ul><ul class=""><li><img class="docActiveImg" src="" alt="不止于书"></li><li>不止于书</li><li>微信号：buzhiyushu</li></ul></div></div>';
	}
	/*end*/
	...
	else if(link_docend.test(doc_url)||link_listindex.test(doc_url)||link_list.test(doc_url)||link_search.test(doc_url)||link_topic.test(doc_url)||link_doudanlist.test(doc_url)||link_doudan.test(doc_url)||link_topiclist.test(doc_url)||link_cartoon.test(doc_url)||link_kyzq.test(doc_url)){
	...
	if(link_sendMessage.test(window.location.href)){
		...
		var getDy_txt = '<div class="getDyInner"><ul><li class="stp1"><a href="http://www.docin.com/app/my/docin/validate" target="_blank" onmousedown="return inpmv(5774);"><span class="fwb">验证邮箱</span><br>激活邮箱，豆元即刻到手</a></li><li class="stp2"><a href="http://www.docin.com/app/docin_upload/index" target="_blank" onmousedown="return inpmv(5775);"><span class="fwb">上传文档</span><br>每日上传文档、源文档被下载，都会奖励豆元哦</a></li><li class="stp3"><a href="http://www.docin.com/app/my/docin/doclist/createdoclist" target="_blank" onmousedown="return inpmv(5776);"><span class="fwb">创建豆单</span><br>整理同主题的文档，不但便于分享还能获得奖励</a></li><li class="stp4"><a href="http://www.docin.com/topic/task/index.jsp" target="_blank" onmousedown="return inpmv(5778);"><span class="fwb">领任务赢豆元</span><br>既能免费体验多种类型游戏，同时还能领取豆元</a></li><li class="stp5"><a href="http://www.docin.com/app/my/fin/addmoney?recharge_from_type=nav-sub1" target="_blank" onmousedown="return inpmv(5777);"><span class="fwb">充值送豆元</span><br>充的越多赠的越多，最高可达 14000豆元</a></li></ul></div>';
		var oSideBar = jQuery('<div class="backToTop"></div>').appendTo(document.body).html('<div class="getDyB"><a class="t" href="javascript:void(0);" style="cursor:default;"><span style="font-size:16px">领</span><br /><span style="font-size:12px;">豆&nbsp;元</span></a><div class="getDyWay">'+getDy_txt+'</div></div><div class="gobackTop"><a href="javascript:void(0);" class="t">返回顶部</a></div><div class="advice"><a href="http://www.docin.com/newMessage/talksWithSys.do" target="_blank" class="t">意见反馈</a></div><div class="docinDownApp">'+dimcode_txt+'</div><div class="docinWX">'+docin_wx+'</div>' + connectOnline);
	}
	else{
	...
	/*微信推广*/
	jQuery(".docinWX").mouseover(function(){
		jQuery(".downloadMore").show().css({left:-593});
	...
	jQuery(".docinWX").mouseout(function(){
...
//baidu share end ###############
function kDefaultFocus(){var d=document,k=d.getElementById('topsearch');if(!k)return false;var ikey=k.value;k.value="";k.focus();k.value=ikey;};
//输入框placeholder
...
LoadJS(picture_image_path_v1+"/js/opensearchsug.js?rand=20160519",1); 
...
function docinShare(n,event,from,id){//n: 1-新浪微博2-QQ空间3-人人4-腾讯微博5-QQ好友6-微信 form: //1:专题  2：终极页  3：豆单  4：书房   5：其他活动
...
shareAnylize(from,id,n);
function shareAnylize(from,id,snstype){
	//from 1:专题  2：终极页  3：豆单  4：书房   5：其他活动   无id填0
	jQuery.post('/jsp_cn/stat/shareStat.jsp',{'from':from,'id':id,'snstype':snstype});
}
...
//终极页banner循环广告
jQuery(function(){
	var oNextAdBtn = jQuery(".bold_nav_item .viewNextTxt");
	if(oNextAdBtn.length == 0){return;}
	var oSliderBox = jQuery(".bold_nav_item ul"),
		oSliderLi = jQuery(".bold_nav_item ul li");
		adNum = oSliderLi.find('p').length,
		iHeight = 30;
		...
		oNextAdBtn.bind("click",function(){
			var iTop = -iHeight*(t+1);
				oSliderLi.stop().animate({top:iTop},"fast",function(){
					if(t==adNum-1){
						oSliderLi.stop().css({top:0});
						t = 0;
					}
					else{
						t++;
