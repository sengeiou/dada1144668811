...
#if 0
extern 	double rble_sin(double x);
extern double rble_cos(double x);
extern double rble_sqrt(double x);
extern double rble_atan2(double x, double y);
#endif


//test_r
#if 0
#define cosf(x)      rble_cos(x)
